...
function Footer() {
  return (
    <div className="flex flex-col lg:flex-row gap-5 w-full min-h-screen bg-zinc-900 p-4 md:p-10 lg:p-20 text-white">
      {/* Left side */}
      <div className='w-full lg:w-1/2 h-full flex flex-col justify-between text-[15vw] md:text-[12vw] lg:text-[10vw] font-semibold uppercase leading-none -mb-10 font-["FoundersGrotesk"]'>
      ...
      {/* Right side */}
      <div className="w-full lg:w-1/2 h-full flex flex-col justify-between font-['FoundersGrotesk'] mt-10 lg:mt-0">
        <div>
        ...
        <div className="dets text-lg md:text-xl font-light font-['NeueMontreal']">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-1 gap-4">
            ...
            <a className="block hover:text-[#CDEA68] transition-colors" href="#">Snap</a>
          </div>
        </div>
      </div>
    </div>
